...
let start_1 = document.getElementById('start_1');
let start_2 = document.getElementById('start_2');
let start_3 = document.getElementById('start_3');
let start_4 = document.getElementById('start_4');
//Start Section
...
let common = function(id){
	...
	document.getElementById('start_1').scrollIntoView();
	 <!-- class="button_start" -->
}
start_1.addEventListener("click", () => {
	 common(start_1);   
});
start_2.addEventListener("click", () => {
	 common(start_2);   
});
start_3.addEventListener("click", () => {
	 common(start_3);   
});
start_4.addEventListener("click", () => {
	 common(start_4);   
});
